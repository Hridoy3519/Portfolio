/**
 * The hero centrepiece: a wireframe train with lit windows running past
 * three layers of scenery, each drifting at its own speed. Purely
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to bottom, color-mix(in srgb, var(--brand) 16%, transparent), transparent 72%)",
        }}
      />

      {/* Stars at night, a low sun by day */}
      <div
      ...
      />
      <div
        className="absolute top-6 right-[12%] h-9 w-9 rounded-full md:h-11 md:w-11"
        style={{
          background: "var(--board-ink)",
          opacity: 0.8,
          boxShadow: "0 0 42px 12px rgba(245, 197, 66, 0.22)",
        }}
      />
